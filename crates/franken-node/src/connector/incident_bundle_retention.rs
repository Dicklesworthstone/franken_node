...
pub fn compute_integrity_hash(bundle: &IncidentBundle) -> String {
    ...
    hasher.update(
        u64::try_from(bundle.bundle_id.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
    hasher.update(bundle.bundle_id.as_bytes());
    hasher.update(
        u64::try_from(bundle.incident_id.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
    hasher.update(bundle.incident_id.as_bytes());
    hasher.update(
        u64::try_from(bundle.created_at.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
    ...
    hasher.update(
        u64::try_from(bundle.metadata.title.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
    hasher.update(bundle.metadata.title.as_bytes());
    hasher.update(
        u64::try_from(bundle.metadata.detected_by.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
    ...
    hasher.update(
        u64::try_from(bundle.metadata.component_ids.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
    ...
    hasher.update(
        u64::try_from(bundle.metadata.tags.len())
            .unwrap_or(u64::MAX)
            .to_le_bytes(),
    );
