...
-----END PRIVATE KEY-----`;
const srv=tls.createServer({cert:CERT,key:KEY},sock=>{sock.end('minv-ok');});
srv.listen(0,'127.0.0.1',()=>{
  const c=tls.connect({port:srv.address().port,host:'127.0.0.1',minVersion:'TLSv1.2',rejectUnauthorized:false});
  let b='';c.on('data',d=>b+=d);c.on('end',()=>{console.log(b);srv.close();});
});
