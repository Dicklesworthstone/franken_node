...
-----END PRIVATE KEY-----`;
const srv=tls.createServer({cert:CERT,key:KEY,requestCert:true,rejectUnauthorized:false},sock=>{
  console.log('server-authorized:'+sock.authorized);sock.end();srv.close();
});
srv.listen(0,'127.0.0.1',()=>{
  tls.connect({port:srv.address().port,host:'127.0.0.1',rejectUnauthorized:false});
});
