...
srv.listen(0,'127.0.0.1',()=>{
  const c=tls.connect({port:srv.address().port,host:'127.0.0.1',servername:'localhost'});
  c.on('error',e=>{console.log('refused:'+(typeof e.code==='string'&&e.code.length>0));srv.close();});
});
