...
mod tests {
    ...
    /// Comprehensive boundary testing for capsule signature verification edge cases.
    ...
    fn capsule_signature_verification_boundary_comprehensive() {
        ...
        unordered_inputs.insert("zebra".to_string(), "value1".to_string());
        unordered_inputs.insert("alpha".to_string(), "value2".to_string());
        unordered_inputs.insert("beta".to_string(), "value3".to_string());

        let mut ordered_inputs = BTreeMap::new();
        ordered_inputs.insert("alpha".to_string(), "value2".to_string());
        ordered_inputs.insert("beta".to_string(), "value3".to_string());
        ordered_inputs.insert("zebra".to_string(), "value1".to_string());

        let mut capsule1 = base_capsule.clone();
        capsule1.inputs = unordered_inputs;
