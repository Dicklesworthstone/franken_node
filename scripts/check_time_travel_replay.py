...
def _checks() -> list:
    ...
    results.append(_check("replay_fixture_identity method", "fn replay_fixture_identity" in src))
    results.append(_check("fixture_identity_replay function", "fn fixture_identity_replay" in src))
